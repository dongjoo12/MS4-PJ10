...
def exchange_main():
    ...
    st.write(f"The Climate Companion Card is {cost_ratio:.2f} times cheaper than maintaining a car.")
    st.write(f"The bus emits {emission_ratio:.2f} times less than the car.")
